...
开闭原则（Open Closed Principle，OCP）由勃兰特·梅耶（Bertrand Meyer）提出，他在 1988 年的著作《面向对象软件构造》
（Object Oriented Software Construction）中提出：软件实体应当 **对扩展开放，对修改关闭** 
...
而不需要修改原代码，所以它是满足开闭原则的。

![example](ocpexamples.gif)